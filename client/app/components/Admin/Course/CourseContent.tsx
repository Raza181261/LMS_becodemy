...
const CourseContent: FC<Props> = ({
  ...
  const newCourseHandler = (item: any) => {
    if (
      item.title === "" ||
      item.description === "" ||
      item.videoUrl === "" ||
      ...
      if (courseContentData.length > 0) {
        ...
        //  use lastvideosection if avaible else use user input
            ...
            <>
              ...
              >
                ...
                <div className="flex w-full items-center justify-between my-0">
                  ...
                  {/* arror button for collapsed video content */}
                ...
                {index === courseContentData.length - 1 && (
                  <div>
                    <p
                      className="flex items-center text-[18px] text-black dark:text-white cursor-pointer"
                      onClick={(e: any) => newCourseHandler(item)}
                    >
