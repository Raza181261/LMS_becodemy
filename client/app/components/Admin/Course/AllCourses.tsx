...
// import { useGetAllCoursesMutation } from "../../../../redux/features/courses/coursesApi";
...
// //   const {isLoading, data, error} = useGetAllCoursesMutation();
// const [getAllCourses, { isLoading, data, error }] = useGetAllCoursesMutation();
    ...
    { field: "created_at", headerName: "Created At", flex: 0.5 },
    {
      ...
      renderCell: (params: any) => (
        <Link href={`/admin/edit-course/${params.row.id}`}>
          <FiEdit2 className="text-black dark:text-white mt-4" size={20} />
        </Link>
      ),
    },
    {
